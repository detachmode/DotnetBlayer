...
using Blayer.ClientSide.Components;

namespace Blayer.ClientSide.Pages
{

    public class IndexBase : ComponentBase
    {
        [Inject] public Blayer.ClientSide.Interactive.Interactive<Api> Interactive { get; set; }
        ...
        public List<(string name, string value)> AllVariables { get; set; }
        ...
        protected override async Task OnAfterRenderAsync()
        {
            if (!InitalLoadDone)
            {
                ...
                // var code = await new HttpClient().GetStringAsync("https://localhost:5001/examples/example1.txt");
        ...
        public async Task Run(string code)
        {
            ...
            AllVariables = Interactive.GetVariables();
